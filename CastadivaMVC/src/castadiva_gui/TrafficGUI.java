...
public class TrafficGUI extends javax.swing.JFrame {
    ...
    public void GenerateTable(Vector data) {
        ...
        //Adding the category Selection Menu QoS
        JComboBox ACComboBox = new JComboBox();

        ACComboBox.addItem("AC_BK");
        ACComboBox.addItem("AC_BE");
        ACComboBox.addItem("AC_VI");
        ACComboBox.addItem("AC_VO");

        trafficTable.table.getColumnModel().getColumn(TrafficTableModel.AC_INDEX).
                setCellEditor(new DefaultCellEditor(ACComboBox));


        //Adding DACME
        JCheckBox dacmeCheckBox = new JCheckBox();

        trafficTable.table.getColumnModel().getColumn(TrafficTableModel.DACME_INDEX).
                setCellEditor(new DefaultCellEditor(dacmeCheckBox));

       JCheckBox redirectCheckBox = new JCheckBox();

        trafficTable.table.getColumnModel().getColumn(TrafficTableModel.REDIRECT_INDEX).
                setCellEditor(new DefaultCellEditor(redirectCheckBox));
        
        trafficTable.setVisible(false);
        trafficTable.setVisible(true);
    }

    public void FillAveragePanel(Float UdpText, Float TcpText) {
    ...
    private void initComponents() {
        ...
        WindowControlPanelLayout.setHorizontalGroup(
            ...
            .add(WindowControlPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(WindowControlPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, SaveInTextFileButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, AcceptButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE))
                .addContainerGap())
        );

        WindowControlPanelLayout.linkSize(new java.awt.Component[] {AcceptButton, SaveInTextFileButton}, org.jdesktop.layout.GroupLayout.HORIZONTAL);

        WindowControlPanelLayout.setVerticalGroup(
            WindowControlPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, WindowControlPanelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        WindowControlPanelLayout.linkSize(new java.awt.Component[] {AcceptButton, SaveInTextFileButton}, org.jdesktop.layout.GroupLayout.VERTICAL);
        ...
        AveragePanelLayout.setHorizontalGroup(
            ...
            .add(AveragePanelLayout.createSequentialGroup()
                ...
                .add(AveragePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, UdpAverageTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, ThroughputAverageTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(AveragePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        ...
        AveragePanelLayout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, AveragePanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(AveragePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                    .add(jLabel3)
        ...
        StatusPanelLayout.setHorizontalGroup(
            ...
            .add(StatusPanelLayout.createSequentialGroup()
                ...
                .add(jLabel2)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(ConsoleTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(layout.createSequentialGroup()
                        .addContainerGap()
                        .add(TableScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 1213, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(jLabel1)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(TableScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, WindowControlPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void addAcceptButtonListener(ActionListener al) {
        AcceptButton.addActionListener(al);
    }

    public void addOrderButtonListener(ActionListener al) {
        OrderButton.addActionListener(al);
    }

    public void addSaveInTextFileButtonListener(ActionListener al) {
    ...
    public class TrafficForm extends JPanel {
        ...
        public void initComponent() {
            ...
            TableColumn mean_delay = table.getColumnModel().getColumn(TrafficTableModel.MEAN_DELAY_INDEX);
            mean_delay.setCellRenderer(new NotEditableTableCellRenderer());
            ...
            //QoS
            TableColumn ac = table.getColumnModel().getColumn(TrafficTableModel.AC_INDEX);
            ac.setMinWidth(30);
            ac.setPreferredWidth(50);
            ac.setCellRenderer(new NotEditableTableCellRenderer());

            TableColumn dacme = table.getColumnModel().getColumn(TrafficTableModel.DACME_INDEX);
            dacme.setCellRenderer(new NotEditableTableCellRenderer());
            dacme.setMinWidth(30);
            dacme.setPreferredWidth(50);

            TableColumn delay = table.getColumnModel().getColumn(TrafficTableModel.DELAY_INDEX);
            delay.setCellRenderer(new NotEditableTableCellRenderer());

            TableColumn redirect = table.getColumnModel().getColumn(TrafficTableModel.REDIRECT_INDEX);
            redirect.setCellRenderer(new NotEditableTableCellRenderer());
            redirect.setMinWidth(30);
            redirect.setPreferredWidth(50);
	...
	public BooleanRenderer() {
	    ...
	    if (isSelected) {
            ...
            if (!table.isCellEditable(row, column)) {
                //table.getComponentAt(row, column).setForeground(Color.yellow);
               //table.getCellEditor().getTableCellEditorComponent(table, value, hasFocus, row, row).setForeground(Color.ORANGE);
            } else {
                //table.getComponentAt(row, column).setForeground(Color.ORANGE);
                //table.getCellEditor().getTableCellEditorComponent(table, value, hasFocus, row, row).setForeground(Color.YELLOW);
            }
        ...
        public class NotEditableTableCellRenderer extends DefaultTableCellRenderer {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
                ...
                try {
                  /*  if (column == TrafficTableModel.DACME_INDEX) {
                        return new BooleanRenderer().getTableCellRendererComponent(table,
                  ...
                  //  }
                    if (column == TrafficTableModel.SPEED_INDEX ||
                            (
                           /*QoS*/ (column == TrafficTableModel.MEAN_DELAY_INDEX ||
