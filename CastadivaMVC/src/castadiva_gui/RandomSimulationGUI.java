 ...
 * @author  jorge
 */
public class RandomSimulationGUI extends javax.swing.JFrame {
    CastadivaModel m_model;
    Map blackBoard;
    RandomTrafficForm randomTrafficTable;
    
    /** Creates new form RandomSimulation */
    public RandomSimulationGUI(CastadivaModel model) {
        initComponents();
     ...
     */
    public String GetSaveFolderText(){
    ...
    public Integer ReturnSimulationTime(){
        int st;
        try{
            st =Integer.parseInt(SimulationTimeTextField.getText());
        }catch(NumberFormatException nfe){
            st = 0;
        }
        return st;
    ...
    public void ChangeSimulationTime(Integer value){
        SimulationTimeTextField.setText(value.toString());
    }
    ...
    public void ModifyBlackBoard(){
        //Change the map.
        blackBoard.MapChange(false, false, false, m_model.WhatBoundX(), m_model.WhatBoundY(),
                false);
        Frame.repaint();
    }
    ...
    public void ChangeSaveFolderText(String text){
    ...
    public void ActivateWindow(){
        ...
        m_model.randomTrafficModel.SetEnable(true);
        GenerateButton.setEnabled(true);
    ...
    public void DisableWindow(){
        ...
        m_model.randomTrafficModel.SetEnable(false);
        GenerateButton.setEnabled(false);
    }
    ...
    public void addSaveFolderActionListener(ActionListener al){
        SearchDirectoryButton.addActionListener(al);
    }
    
    public void addDelRowButtonListener(ActionListener al){
        DeleteRowButton.addActionListener(al);
    }
    
    public void addDuplicateActionListener(ActionListener al){
    ...
    public void addGenerateActionListener(ActionListener al){
    ...
    public void addSimulationTimeTextFieldListener(ActionListener al){
        SimulationTimeTextField.addActionListener(al);
    }
    
    public void addPauseSimulationTimeTextFieldListener(ActionListener al){
        PauseTimeTextField.addActionListener(al);
    }
    
    public void addSpeedSimulationTextFieldListener(ActionListener al){
    ...
    private void initComponents() {
        ...
        OlsrCheckBox = new javax.swing.JCheckBox();
                ...
                .add(SourcePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(SourcePanelLayout.createSequentialGroup()
                        ...
                        .add(SourcePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(SourcePanelLayout.createSequentialGroup()
                                .add(SourcePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                                    .add(org.jdesktop.layout.GroupLayout.LEADING, MaxNodeNumberSpinner)
                                    .add(org.jdesktop.layout.GroupLayout.LEADING, RunsSpinner)
        ...
        TrafficPanelLayout.setHorizontalGroup(
            ...
            .add(TrafficPanelLayout.createSequentialGroup()
                ...
                .add(TrafficPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, RandomTrafficScrollPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 905, Short.MAX_VALUE)
                    .add(TableTitleLabel)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, TrafficPanelLayout.createSequentialGroup()
                        .add(jLabel17)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(ConsoleTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(DeleteRowButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(DeleteAllButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)))
                .addContainerGap())
        );
        TrafficPanelLayout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, TrafficPanelLayout.createSequentialGroup()
                ...
                .add(TableTitleLabel)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(RandomTrafficScrollPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(TrafficPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                    .add(jLabel17)
        ...
        OlsrCheckBox.setText("OLSR");
        OlsrCheckBox.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
                ...
                .add(ProtocolPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(ProtocolPanelLayout.createSequentialGroup()
                        .add(ProtocolPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(NoneCheckBox))
                        .add(21, 21, 21)
                        .add(ProtocolPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(OlsrCheckBox, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(AodvCheckBox, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE))))
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(Frame, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE)
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                        .add(ScenarioPanel, 0, 169, Short.MAX_VALUE)
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(ChoosePanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(ProtocolPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private javax.swing.JCheckBox OlsrCheckBox;
