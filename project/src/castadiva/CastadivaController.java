...
public class CastadivaController {
    ...
    class SaveListener implements ActionListener {
        public void actionPerformed(ActionEvent e){
            ...
            if (!(file = ExplorationWindow("Save",
                    JFileChooser.DIRECTORIES_ONLY)).equals("")) {
                if(!m_model.SaveCastadiva(file)) ShowSaveErrorMessage(
    ...
    class AboutBoxListener implements ActionListener {
        public void actionPerformed(ActionEvent e){
            m_about.UpdateText(m_model.ReadTextFile(m_model.Help_Folder + File.separator
                    + "about.txt"));
    ...
    class ReplayPositionListener implements ActionListener{
        public void actionPerformed(ActionEvent e){
            ...
            if(m_simulationWindow.ReturnReplayTime() < 0) m_simulationWindow.ChangeReplayTime(0);
            if(m_model.replay){
     ...
     ****************************************************************************/
     ...
     private void ShowHelp(){
         m_helpWindow.UpdateText(m_model.ReadTextFile(m_model.Help_Folder + File.separator
                 + m_model.helpFiles[m_model.selectedHelp]));
     ...
     class AfterHelp implements ActionListener{
        public void actionPerformed(ActionEvent e){
            ...
            if(m_model.selectedHelp > m_model.helpFiles.length-1) m_model.selectedHelp = 0;
            ShowHelp();
        }
    } 
     ...
     class BeforeHelp implements ActionListener{
         public void actionPerformed(ActionEvent e){
             m_model.selectedHelp--;
             if(m_model.selectedHelp<0) m_model.selectedHelp = m_model.helpFiles.length-1;
             ShowHelp();
         }
     }
     ...
     class LanguageHelp implements ActionListener{
         public void actionPerformed(ActionEvent e){
             ...
             switch (m_helpWindow.GetLanguageIndex()) {
                 case 0 : m_model.Help_Folder = "helpEN";
                 break;
                 case 1 : m_model.Help_Folder = "helpES";
                 break;
             }
             m_helpWindow.UpdateText(m_model.ReadTextFile(m_model.Help_Folder + File.separator
                     + m_model.helpFiles[m_model.selectedHelp]));
