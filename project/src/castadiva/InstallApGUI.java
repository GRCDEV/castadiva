                                ...
                                .add(DevicesPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    ...
                                    .add(org.jdesktop.layout.GroupLayout.TRAILING, DevicesPanelLayout.createSequentialGroup()
                                        .add(DevicesPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                            .add(org.jdesktop.layout.GroupLayout.LEADING, SwitchTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)
                                            .add(EthernetTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE))
            ...
            .add(InternetPanelLayout.createSequentialGroup()
                .add(InternetPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(InternetPanelLayout.createSequentialGroup()
                        ...
                        .add(InternetPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jLabel16)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, WifiIpTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
                            .add(jLabel18)
                            .add(SSIDTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE))))
                .addContainerGap())
        );
            ...
            .add(FoldersPanelLayout.createSequentialGroup()
                .add(FoldersPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(FoldersPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .add(FoldersPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(ComputerFolderTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                            .add(jLabel5)
                            .add(jLabel8)
                            .add(jLabel7)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, ApNfsTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                            .add(ScriptFolderTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)))
                    .add(FoldersPanelLayout.createSequentialGroup()
                        .add(88, 88, 88)
                        .add(jLabel17)))
                .addContainerGap())
